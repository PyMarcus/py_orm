...
class Picole(ModelBase):
    ...
    sabor: Mapped[typing.Type[typing.Optional[Sabor]]] = orm.relationship("Sabor", lazy="joined")

    id_tipo_embalagem: int = sa.Column(sa.Integer, sa.ForeignKey("tipos_embalagens.id"))
    tipo_embalagem: Mapped[typing.Type[typing.Optional[TipoEmbalagem]]] = orm.relationship("TipoEmbalagem", lazy="joined")

    id_tipo_picole: int = sa.Column(sa.Integer, sa.ForeignKey("tipos_picoles.id"))
    tipo_picole: Mapped[typing.Type[typing.Optional[TipoPicole]]] = orm.relationship("TipoPicole", lazy="joined")

    # um picole pode ter varios ingredientes
    ingredientes: Mapped[typing.Type[typing.Optional[Ingrediente]]] = orm.relationship("Ingrediente",
                                                              secondary=ingredientes_picole,
                                                              backref="ingrediente",
                                                              lazy="joined",
                                                              )
    # um picole pode ter conservantes ou nenhum
    conservantes: Mapped[typing.Type[typing.Optional[Conservante]]] = orm.relationship("Conservante",
                                                              secondary=conservantes_picole,
                                                              backref="conservante",
                                                              lazy="joined",
                                                              )
    # um picole pode ter varios aditivos nutritivos ou nenhum
    aditivos: Mapped[typing.Type[typing.Optional[AditivoNutritivo]]] = orm.relationship("AditivoNutritivo",
